...
$script:GeneratedManifest=Read-ACLMGeneratedManifest -Path $ManifestPath -FallbackVersion '0.10.4'
...
function Write-RunManifest {
  ...
  try{
    ...
    $manifest=Merge-ACLMRunManifest -Generated $script:GeneratedManifest -ActiveInstalledPhysics $script:ActiveInstalledPhysics -Observed $observed -Runtime $runtime -FallbackVersion '0.10.4'
